...
To bring up an Essential PKS Cluster with NCP 2.4 on top of VIO 6.0 use the following HEAT Stack:

_EssPKS_1.14.3_NCP_2.4_OS_Cloud_provider_IP_Access.yaml_
...
parameters:
  ...
  nsx_package_path: /root/nsx-container-2.4.1.13515827.zip
...
| ssh\_private\_key  | File path to the SSH private key to use for the nodes to ssh to each other.|
...
***Do not specify the ssh_private_key in params.yaml, use the --parameter-file argument***
